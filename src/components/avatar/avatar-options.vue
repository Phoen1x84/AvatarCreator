<template>
    <div class="configure-group">
      ...
      <input v-for="item in features.feature" :key="item.id" type="radio" class="configure-group__input" v-bind:id="item.group" name="features" /> 
      <label v-for="item in features.feature" :key="item.id" v-bind:for="item.group" class="configure-group__title">
          {{item.group}}
      </label>
      <div class="configure-group__options" v-for="item in features.feature" :key="item.id">
          <div class="configure-option" v-for="item in item.options" :key="item.id">              
              <input
                  class="configure-option__input"
                  v-bind:id="item.labelText"
                  v-bind:type="item.fieldType"
                  v-bind:name="item.name"
                  v-bind:value="item.svgCode"
...
export default {
            ...
            options: [
              {
                id: "0",
                labelText: "hair-1",
                svgCode: `<g id="hair1" fill="#967C32">
              ...
              },
              {
                id: "1",
                labelText: "hair-2",
                svgCode: ` <g id="hair2" fill="#09333F">
              ...
              },
              {
                id: "2",
                labelText: "hair-3",
                svgCode: `<g id="hair3" fill="#524D42">
              ...
              },
              {
                id: "3",
                labelText: "hair-4",
                svgCode: `<g id="hair4" fill="#B34A34">
              ...
              },
              {
                id: "4",
                labelText: "hair-5",
                svgCode: `<g id="hair5" fill="#FFC829">
  ...
  methods: {
    updateFeature: function(item) {
      this.$eventBus.$emit("updateFeature", item.currentTarget.value);
    }
  }
};
</script>
